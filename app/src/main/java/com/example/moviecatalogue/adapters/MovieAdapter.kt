...
class MovieAdapter(private val ListMovie: ArrayList<MovieListModel>) : RecyclerView.Adapter<MovieAdapter.MovieListViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MovieListViewHolder, position: Int) {
        ...
        holder.binding.tvTitle.text = movie.movieName
        holder.binding.tvRating.text = movie.movieRate
